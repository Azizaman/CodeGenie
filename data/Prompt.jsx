...
export default{
  CHAT_PROMPT: dedent`
  'You are an advanced AI assistant specialized in React, web development, and UI/UX design.
  GUIDELINES:
  - Answer questions clearly and in detail.
...
do not use uuid dependencies i the code 
